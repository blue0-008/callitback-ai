...
import { getQuizzes, saveQuizzes, getDecks, saveDecks, addSession, getStats, saveStats } from "@/lib/store";
import { saveSummary, type SavedSummary } from "@/lib/summaryStore";
